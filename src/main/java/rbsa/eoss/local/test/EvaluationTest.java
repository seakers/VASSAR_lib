...
import rbsa.eoss.*;
import rbsa.eoss.problems.ClimateCentric.ArchitectureEvaluator;
...
public class EvaluationTest {
    ...
    public static void main(String[] args){
        ...
        BaseParams params = rbsa.eoss.problems.ClimateCentric.Params.initInstance(path,
...
//      {"LEO-600-polar-NA","SSO-600-SSO-AM","SSO-600-SSO-DD","SSO-800-SSO-AM","SSO-800-SSO-DD"};
        ...
        testArch = new rbsa.eoss.problems.ClimateCentric.Architecture(map, 1);
