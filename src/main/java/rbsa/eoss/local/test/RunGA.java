...
//import rbsa.eoss.*;
//import seak.rbsa.eoss.architecture.operators.IntegerUM;
//
...
//        ArchitectureEvaluationManager.getInstance().init(8);
//        Problem problem = new InstrumentAssignment(new int[]{1}, ArchitectureEvaluationManager.getInstance());
//
...
//        }
//
//        ArchitectureEvaluationManager.getInstance().clear();
//        pool.shutdown();
