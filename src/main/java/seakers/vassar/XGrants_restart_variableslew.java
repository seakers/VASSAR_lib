...
public class XGrants_restart_variableslew {
...
//                    initialization),stateFile,10);
            ...
            while (algorithm.getNumberOfEvaluations() < 10000) {
                ...
                try {
                    FileOutputStream f = new FileOutputStream("./src/test/output/xgrants/0227_current_population.txt");
                ...
                try{
                    PrintWriter out = new PrintWriter("./src/test/output/xgrants/0227_variables_"+algorithm.getNumberOfEvaluations()+".txt");
                    for (Solution sol : currentPop) {
                ...
                try {
                    PopulationIO.writeObjectives(new File("./src/test/output/xgrants/0227_objectives_"+algorithm.getNumberOfEvaluations()+".txt"), currentPop);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
