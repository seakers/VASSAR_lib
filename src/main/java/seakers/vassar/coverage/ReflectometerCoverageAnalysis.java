...
//        CoverageDefinition covDef1 = new CoverageDefinition("covdef1", landPoints, earthShape);
        ...
        ReflectometerEventAnalysis reflEvent = (ReflectometerEventAnalysis) eaf.createReflectionAnalysis(EventAnalysisEnum.REFLECTOR, walker, tx, covDefs, propertiesEventAnalysis,Math.toRadians(this.coverageGridGranularity));
