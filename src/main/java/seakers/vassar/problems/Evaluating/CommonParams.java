...
public class CommonParams extends AssigningParams {
...
//        this.adhocRulesClp = this.problemPath + "/clp/smap_rules_test.clp";
    ...
    public BaseParams copy(){
        return new CommonParams(super.orbitList, this.problemName, super.resourcesPath, super.reqMode, super.name, super.runMode);
    }
}
