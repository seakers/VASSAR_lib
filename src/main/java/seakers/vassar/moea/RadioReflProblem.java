...
public class RadioReflProblem extends AbstractProblem {
    public RadioReflProblem() {
        super(6,4,0);
    }
    ...
    public void evaluate(Solution solution) {
        ...
        try {
            ...
            if(jsonString.equals("hello world")) {
                ...
                f[3] = Math.sqrt(Math.pow(atRes,2)+Math.pow(ctRes,2))/1000;
        ...
        for(int m = 0; m < r; m++) {
            for(int n = 0; n < s; n++) {
                ...
                OrbitInstrumentObject radiometerOnlySatellite = new OrbitInstrumentObject(new String[]{"CustomRadiometer","L-band_Reflectometer"},orbitName,fov);
