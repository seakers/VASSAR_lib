...
//    public abstract AbstractArchitectureEvaluator getNewInstance(JSONObject inputData, BaseParams params);
...
//                for (String param: params.measurementsToInstruments.keySet()) {
    ...
    protected HashMap<String, Double> getRevisitTimes(BaseParams params, ValueVector thefovs, String[] fovs, boolean recalculateRevisitTime, int[] revTimePrecomputedIndex, Rete r, MatlabFunctions m) throws JessException {
        ...
        // Package the revisit times in a hash
        HashMap<String, Double> revisitTimes = new HashMap<>();
        revisitTimes.put("Global", therevtimesGlobal);
        revisitTimes.put("US", therevtimesUS);
        return revisitTimes;
    }
