...
//    public Result evaluateArchitectureSyncJSON(JSONObject arch, String mode) {
//        return evaluateArchitectureSyncJSON(arch, mode, false);
//    }
//
//    public Result evaluateArchitectureSyncJSON(JSONObject arch, String mode, boolean debug) {
//        AbstractArchitectureEvaluator t = evaluator.getNewInstance(resourcePool, arch, "Slow");
//        t.setDebug(debug);
//
//        Future<Result> future = executorService.submit(t);
