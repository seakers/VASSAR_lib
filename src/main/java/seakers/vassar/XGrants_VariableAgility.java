...
//                    initialization),stateFile,10);
            ...
            while (algorithm.getNumberOfEvaluations() < 2000) {
                ...
                try {
                    ...
                    FileOutputStream f = new FileOutputStream("./results/xgrants/011224_current_population.txt");
                ...
                try{
                    ...
                    PrintWriter out = new PrintWriter("./results/xgrants/011224_variables_"+algorithm.getNumberOfEvaluations()+".txt");
                    for (Solution sol : currentPop) {
                ...
                try{
                    //PrintWriter out = new PrintWriter("./src/test/output/xgrants/0223_variables_"+algorithm.getNumberOfEvaluations()+".txt");
                    PrintWriter out = new PrintWriter("./results/xgrants/011224_attributes_"+algorithm.getNumberOfEvaluations()+".txt");
                    for (Solution sol : currentPop) {
                ...
                try {
                    ...
                    PopulationIO.writeObjectives(new File("./results/xgrants/011224_objectives_"+algorithm.getNumberOfEvaluations()+".txt"), currentPop);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
