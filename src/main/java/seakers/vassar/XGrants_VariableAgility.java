...
//                    initialization),stateFile,10);
            ...
            while (algorithm.getNumberOfEvaluations() < 10000) {
                ...
                try {
                    ...
                    FileOutputStream f = new FileOutputStream("./src/test/output/xgrants/0310_current_population.txt");
                ...
                try {
                    ...
                    PopulationIO.writeObjectives(new File("./src/test/output/xgrants/0310_objectives_"+algorithm.getNumberOfEvaluations()+".txt"), currentPop);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
