...
public abstract class BaseParams {
    ...
    public String designHeuristicsRulesClp;
    public String constellationRulesClp;
...
//    public HashMap<String, Double> revtimes;
    ...
    private void configurePath(String resourcesPath, String problemName){
        ...
        this.designHeuristicsRulesClp       = problemPath + "/clp/design_heuristics_rules.clp";
        this.constellationRulesClp          = problemPath + "/clp/constellation_rules.clp";
