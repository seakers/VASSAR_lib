...
public class GigaAssigningParams extends AssigningParams {
    ...
    public GigaAssigningParams(String resourcesPath, String mode, String name, String runMode){
