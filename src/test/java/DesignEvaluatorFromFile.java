...
public class DesignEvaluatorFromFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("C:/Users/Ben/Documents/xgrants_downloads/combined_results_012224.csv"))) { // CHANGE THIS FOR YOUR IMPLEMENTATION
            String line;
            int count = 0;
