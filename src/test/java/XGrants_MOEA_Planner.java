...
import seakers.vassar.moea.XGrantsProblemPlanner;
...
public class XGrants_MOEA_Planner {
    public static void main(String[] args){
        try{
            OrekitConfig.init(12);
            XGrantsProblemPlanner problem = new XGrantsProblemPlanner();
    ...
    //                    initialization),stateFile,10);
            ...
            while (algorithm.getNumberOfEvaluations() < 10000) {
                ...
                try {
                    ...
                    FileOutputStream f = new FileOutputStream("./results/planner/040924_current_population.txt");
                ...
                try{
                    ...
                    PrintWriter out = new PrintWriter("./results/planner/040924_variables_"+algorithm.getNumberOfEvaluations()+".txt");
                    for (Solution sol : currentPop) {
                ...
                try{
                    //PrintWriter out = new PrintWriter("./src/test/output/xgrants/0223_variables_"+algorithm.getNumberOfEvaluations()+".txt");
                    PrintWriter out = new PrintWriter("./results/planner/040924_attributes_"+algorithm.getNumberOfEvaluations()+".txt");
                    for (Solution sol : currentPop) {
                        out.println(sol.getAttribute("hsr")+","+sol.getAttribute("swath")+","+sol.getAttribute("vnirSNR")+","+sol.getAttribute("spectralResolution"));
                    }
                    out.close();
                } catch (FileNotFoundException e) {
                    System.out.println("File not found");
                ...
                try {
                    ...
                    PopulationIO.writeObjectives(new File("./results/planner/040924_objectives_"+algorithm.getNumberOfEvaluations()+".txt"), currentPop);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
