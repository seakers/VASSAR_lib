%% mass_EPS.m
function [design_EPS] = design_EPS(Pavg_payload,Ppeak_payload,frac_sunlight,worst_sun_angle,period,lifetime,dry_mass,DOD)
%% Parameters
...
design_EPS = [mass_EPS, P_BOL, Asa, mass_SA];
end 