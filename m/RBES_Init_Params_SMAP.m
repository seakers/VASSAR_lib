...
function RBES_Init_Params_SMAP(varargin)
global params
...
params.requirement_rules_xls = '.\xls\SMAP Requirement Rules.xlsx';
params.capability_rules_xls= '.\xls\SMAP Instrument Capability Definition.xlsx';
params.optimization_xls= '.\xls\Decadal Case Study Parameters.xlsx';
params.value_aggregation_xls = '.\xls\SMAP Aggregation Rules.xlsx';
params.aggregation_rules_xls = '.\xls\SMAP Aggregation Rules.xlsx';

%% Paths for specific clp files

params.search_heuristic_rules_adhoc_clp  = '.\\clp\\search_heuristic_rules_smap.clp';
params.down_selection_rules_adhoc_clp     = '.\\clp\\down_selection_rules_smap.clp';

%% Pool of instruments to be considered
% [~,txt,~] = xlsread(params.optimization_xls,'Ref packaging');
% load Decadal_Instrument_names
params.instrument_list = {'SMAP_ANT','SMAP_RAD','SMAP_MWR','CMIS','VIIRS','BIOMASS'};
...
params.potent_orbits = {'LEO-600-polar-NA','SSO-600-SSO-AM','SSO-600-SSO-DD','SSO-800-SSO-AM','SSO-800-SSO-DD'};
params.orbit_list = params.potent_orbits;
...
params.ref_pack_arch.arch = [1 1];

params.ref_pach_arch_map = pack_arch_to_hashmap(params.ref_pack_arch.arch,params.instrument_list,params.mission_names);

params.packaging_instrument_list= params.instrument_list;
params.satellite_names= 'SMAP';
