function [S_DSM,E_DSM] = PACK_compute_DSMs()
global params
...
for i = 1:N
    for j = 1:N
        if i < j
            ...
            [S_DSM(ind1,ind2),E_DSM(ind1,ind2)] = RBES_compute_synergy_cost(payloads{n,1},payloads{n,2},0);
            n = n + 1;
        end
    end
end
...
RBES_graph_DSM(params.packaging_instrument_list,-E_DSM,'green-red',[filepath 'E_DSM.gv']);
