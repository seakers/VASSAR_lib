...
function [score,panel_scores,objective_scores,subobjective_scores,data_continuity_score,data_continuity_matrix,cost,orbit] = RBES_Evaluate_Mission2(mission)
global params
...
if n>2 || params.USE_LOOKUP_TABLES == 0 %% (Option by default)
    ...
    results = RBES_Evaluate_Manifest2;
    orbit = results.orbit;
    score = results.score;
    cost = results.cost;
