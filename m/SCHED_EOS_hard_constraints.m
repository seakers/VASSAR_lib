function SCHED_EOS_hard_constraints
...
assert_hard_constraint('by-beginning-constraints','ORBVIEW-SEAWIFS TRMM LANDSAT-7 TERRA');% boundary conditions
assert_hard_constraint('by-end-constraints','SORCE CLOUDSAT CALIPSO OSTM');% boundary conditions
