...
% %% Aggregation
% 
% jess deftemplate AGGREGATION::STAKEHOLDER (slot id) (slot fuzzy-value) (slot parent) (slot index) (slot satisfaction) (slot satisfied-by) (multislot obj-scores) (slot reason) (multislot weights);
% jess deftemplate AGGREGATION::OBJECTIVE (slot id) (slot fuzzy-value) (slot index) (slot satisfaction) (slot reason) (multislot subobj-scores) (slot satisfied-by) (slot parent) (multislot weights);
% jess deftemplate AGGREGATION::SUBOBJECTIVE (slot id) (slot fuzzy-value) (slot index) (slot satisfaction) (multislot attributes) (multislot attrib-scores) (multislot reasons) (slot reason) (slot satisfied-by) (slot parent);
% jess deftemplate AGGREGATION::ATTRIBUTE (slot id) (slot fuzzy-value) (slot satisfaction) (slot reason) (slot satisfied-by) (slot parent);
% jess deftemplate AGGREGATION::VALUE (slot satisfaction) (slot fuzzy-value) (slot reason) (multislot weights) (multislot sh-scores);
% 
% 
